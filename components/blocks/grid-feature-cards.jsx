            ...
            <div
                ...
                <div
                    ...
                    <GridPattern
                        ...
                        x="-12"
                        y="4"
                        squares={FIXED_PATTERN}
                        className="fill-foreground/5 stroke-foreground/25 absolute inset-0 h-full w-full mix-blend-overlay" />
                </div>
            </div>
            <feature.icon className="text-foreground/75 size-6" strokeWidth={2} aria-hidden />
            <h3 className="mt-10 text-lg md:text-base">{feature.title}</h3>
